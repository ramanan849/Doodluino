...
void drawMainMenu() {
  ...
  tft.fillRect(100,250,PLATFORM_WIDTH-5, PLATFORM_HEIGHT, GREEN); // dont 
  tft.fillRect(4,290,PLATFORM_WIDTH-5, PLATFORM_HEIGHT, GREEN);
  tft.fillRect(150,340,PLATFORM_WIDTH-5, PLATFORM_HEIGHT, GREEN);
  //tft.fillRect(180,190,PLATFORM_WIDTH-5, PLATFORM_HEIGHT, GREEN);
...
void readMenuInput() {
  ...
  if (state.currentMenu == MAIN_MENU || state.currentMenu == LEVEL_MENU) {
      ...
      if (yValue > 600) { currentSelection++; if (currentSelection > maxOption) currentSelection = 0; inputProcessed = true; }
      else if (yValue < 400) { currentSelection--; if (currentSelection < 0) currentSelection = maxOption; inputProcessed = true; }
