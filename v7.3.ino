...
GameState state;
static bool settingsFirstDraw = true;
...
static bool objectiveFirstDraw = true;
...
void setup() {
  ...
  state.currentMenu = OBJECTIVE_SCREEN;; // Start at main menu
...
void drawMainMenu() {
  ...
  tft.fillRect(100,270,PLATFORM_WIDTH-5, PLATFORM_HEIGHT, GREEN); // dont - oh no!!!
  tft.fillRect(4,310,PLATFORM_WIDTH-5, PLATFORM_HEIGHT, GREEN);
  tft.fillRect(150,360,PLATFORM_WIDTH-5, PLATFORM_HEIGHT, GREEN);
...
void drawLevelMenu() {
  ...
  if (state.selectedOption != lastSelection || levelMenuFirstDraw) {
    if (levelMenuFirstDraw) {
       ...
       tft.setCursor(20, 30); tft.print("SELECT LEVEL"); tft.setTextSize(2);
  ...
  // tft.print("Use Joystick to Navigate");
}
...
void drawHighScores() {
  if (!highScoresDrawn) {
      ...
      tft.setCursor(40, 80); tft.print("EASY: "); tft.print(highScore.easy_score); tft.setTextColor(YELLOW);
      tft.setCursor(40, 120); tft.print("MEDIUM: "); tft.print(highScore.med_score); tft.setTextColor(RED);
      tft.setCursor(40, 160); tft.print("HARD: "); tft.print(highScore.hard_score); tft.setTextColor(MAGENTA);
      tft.setTextColor(RED); tft.setCursor(20, 220); tft.print("Press Select to go BACK");
      highScoresDrawn = true;
  }
}

void showObjectiveScreen() {
    if (objectiveFirstDraw) {
        ...
        // Objective
        tft.setCursor(10, 50);
        tft.print("Objectives:");
        tft.setCursor(10,70);
        tft.setTextColor(WHITE);
        tft.print("- Jump higher!");
        tft.setCursor(10,90);
        tft.print("- Dodge obstacles ");
        tft.fillCircle(225, 95, 5, RED); // Obstacle graphic
        tft.setCursor(10, 110);
        tft.print("- Land on platforms");
        tft.fillRect(160, 130, 40, 8, GREEN); // Platform graphic

        // Features
        tft.setCursor(10, 150);
        tft.setTextColor(YELLOW);
        tft.print("As you climb:");
        tft.setCursor(10, 170);
        tft.setTextColor(WHITE);
        tft.print("- Gravity increases");
        tft.setCursor(10, 190);
        tft.print("- More obstacles");
        tft.setCursor(10, 210);
        tft.print("- Fewer platforms");
        tft.setCursor(10, 230);
        tft.print("- Faster scrolling");

        // Levels
        // tft.setCursor(10, 230);
        // tft.print("Level Differences:");
        // tft.setCursor(20, 250);
        // tft.print("EASY: Static elements");
        // tft.setCursor(20, 270);
        // tft.print("MED: Moving platforms");
        // tft.setCursor(20, 290);
        // tft.print("HARD: Smart obstacles");
        ...
        objectiveFirstDraw = false;
        
        
    }
}

// void showObjectiveScreen2() {
//     if (objectiveFirstDraw) {
//         tft.fillScreen(BLACK);
//         tft.setTextColor(YELLOW);
//         tft.setTextSize(2);
...
//         tft.setCursor(20, 10);
//         tft.setTextSize(3);
//         tft.print("HOW TO PLAY - 2");
//         tft.setTextSize(2);
        
//         // Objective
//         tft.setCursor(10, 50);
//         tft.print("Controls: Joystick!");
//         tft.setCursor(10,70);
//         tft.setTextColor(WHITE);
//         tft.print("- Left & Right to Manoeuvre");
//         tft.setCursor(10,90);
//         tft.print("- Top & Bottom to Navigate Levels");
//         tft.fillCircle(225, 95, 5, RED); // Obstacle graphic
//         tft.setCursor(10, 110);
//         tft.print("- Click to Go Back/ Start");
//         tft.fillRect(160, 130, 40, 8, GREEN); // Platform graphic
...
void drawSettings(){
  ...
  if (state.selectedOption != lastSelection || settingsFirstDraw) {
    if (settingsFirstDraw) {
       tft.fillScreen(BLACK); tft.setTextColor(MAGENTA); tft.setTextSize(3);
       tft.setCursor(15, 30); tft.print("Game Settings"); tft.setTextSize(2);
       levelMenuFirstDraw = false;
    } else { tft.fillRect(35, 110, 170, 170, BLACK); } // Clear menu area + back
  ...
  switch(state.currentMenu) {
      case MAIN_MENU:
          switch(state.mainMenuSelection) {
              ...
              case 2: state.currentMenu = OBJECTIVE_SCREEN; 
